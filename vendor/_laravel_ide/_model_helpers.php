...
namespace App\Models {
     ...
     * App\Models\Comuna
     *
     * @property mixed $muni_codi
     * @property string $comu_nomb
     * @property int $comu_codi
     * @method static \Illuminate\Database\Eloquent\Builder<Comuna>|Comuna whereComuCodi($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comuna>|Comuna whereComuNomb($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comuna>|Comuna whereMuniCodi($value)
     ...
     */
    class Comuna extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     *
     * @property string $pais_codi
     * @property string $depa_nomb
     * @property int $depa_codi
     * @method static \Illuminate\Database\Eloquent\Builder<Departamento>|Departamento whereDepaCodi($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Departamento>|Departamento whereDepaNomb($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Departamento>|Departamento wherePaisCodi($value)
     ...
     * App\Models\Pais
     *
     * @property mixed $pais_capi
     * @property string $pais_nomb
     * @property string $pais_codi
     * @method static \Illuminate\Database\Eloquent\Builder<Pais>|Pais wherePaisCodi($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pais>|Pais wherePaisNomb($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pais>|Pais wherePaisCapi($value)
